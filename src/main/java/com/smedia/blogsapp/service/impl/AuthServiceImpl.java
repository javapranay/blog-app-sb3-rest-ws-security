...
import com.smedia.blogsapp.exception.BlogAPIException;
...
import com.smedia.blogsapp.security.JwtTokenProvider;
...
public class AuthServiceImpl implements AuthService {
	...
	public String register(RegisterDto registerDto) {
		...
		Role userRole = roleRepository.findByName("ROLE_USER").get(); // default Role for registering user
		roles.add(userRole);
		user.setRoles(roles);
